...
def main():
    ...
    if len(args.files) == 1:
        ...
        data = EHRdataFromPickles(root_dir = args.root_dir, file = args.files[0], sort = False,
        test_ratio = args.test_ratio, valid_ratio = args.valid_ratio, model=args.which_model) #No sort before splitting
